...
import StraficationNode from './special/stratification';
import ApplicationNode from './special/application';
import FieldNode from './special/field';
import ArchitectureNode from './special/architecture';
import ImgNode from './special/img';
...
export const registerCustomElement = (lf) => {
  ...
  lf.register(StraficationNode);
  lf.register(ApplicationNode);
  lf.register(FieldNode);
  lf.register(ArchitectureNode);
  lf.register(ImgNode);
}
